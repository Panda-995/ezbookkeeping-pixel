    ...
    theme: {
        ...
        themes: {
            light: {
                ...
                colors: {
                    primary: "#dd5d3d",
                    "primary-darken-1": "#b8462d",
                    "on-primary": "#24130d",
                    secondary: "#2d4a3f",
                    "secondary-darken-1": "#20362d",
                    "on-secondary": "#ffffff",
                    success: "#176b45",
                    ...
                    "grey-800": "#424242",
                    "grey-900": "#212121",
                    "perfect-scrollbar-thumb": "#b8ab99",
                    "skin-bordered-background": "#fffdf8",
                    "skin-bordered-surface": "#fffdf8",
                    "expansion-panel-text-custom-bg": "#eee7da",
                },
                variables: {
                    "code-color": "#ff8000",
            ...
            dark: {
                ...
                colors: {
                    ...
                    teal: "#8fcbb5",
                    background: "#111815",
                    "on-background": "#f4efe5",
                    surface: "#19211e",
                    "on-surface": "#f4efe5",
                    "notification-background": "#19211e",
