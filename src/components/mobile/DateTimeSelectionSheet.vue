<template>
    <f7-sheet swipe-to-close swipe-handler=".swipe-handler" class="date-time-selection-sheet" style="height:auto"
        ...
        <f7-toolbar class="toolbar-with-swipe-handler">
            ...
            <div class="right">
                <f7-link :icon-f7="mode === 'time' ? 'calendar' : 'clock'" :aria-label="mode === 'time' ? tt('Date') : tt('Time')" @click="switchMode"></f7-link>
                <f7-button round fill icon-f7="checkmark_alt" :aria-label="tt('Confirm')" @click="confirm"></f7-button>
            </div>
        </f7-toolbar>
