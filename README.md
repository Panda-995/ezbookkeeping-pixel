...
- Sign-up now asks only for username, email, password, and confirmation. Display name, locale defaults, and common categories are prepared automatically before the user enters the overview.
